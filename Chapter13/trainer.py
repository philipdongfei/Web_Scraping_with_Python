...
class TesseractTrainer():
    def __init__(self):
        ...
        self.fontName = "df_captchaFont"
        self.directory = "/home/philip/LearnDemo/Web_Scraping_with_Python/Chapter13/training_data"
    ...
    def renameFiles(self):
        ...
        for fileName in files:
            if fileName.endswith(".box"):
                ...
                print("tiffFile: {}".format(tiffFile))
                print("boxFile: {}".format(boxFile))
